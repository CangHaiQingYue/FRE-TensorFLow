...
def fre_net(model_name, inputs, model_state):
    with tf.variable_scope(model_name,'FRE', [inputs]):
        ...
        net = tf.layers.conv2d(net, filters=128, kernel_size=3,
                                ...
                                use_bias=True, name='conv2/conv2_1')
        ...
        net = tf.layers.conv2d(net, filters=256, kernel_size=3,
                                padding='same', activation=tf.nn.relu,
                                use_bias=True, name='conv3/conv3_1')
        ...
        net = tf.layers.conv2d(net, filters=512, kernel_size=3,
                                padding='same', activation=tf.nn.relu,
                                use_bias=True, name='conv4/conv4_1')
        ...
        net = slim.conv2d(net, num_outputs=512, kernel_size=3, stride=1, rate=1, scope='conv5/conv5_2')
        net = slim.conv2d(net, num_outputs=512, kernel_size=3, stride=1, rate=1, scope='conv5/conv5_3')
